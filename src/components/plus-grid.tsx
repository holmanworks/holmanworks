  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 top-2 border-t border-gray-100"></div>
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-gray-100 group-last/row:block"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-gray-100 group-last/row:block"></div>
      </div>
      {children}
    </div>
  )
...
export function PlusGridIcon({
  ...
  return (
    <svg
      ...
      className={clsx(
        className,
        'absolute size-[15px] fill-gray-200',
        yClass,
        xClass,
      )}
    >
